...
// logs to Google Cloud Observability. See https://firebase.google.com/docs/genkit/observability/telemetry-collection.
...
export const menuSuggestion = onCallGenkit({
  ...
  // Verified app users can use your API. Read more at https://firebase.google.com/docs/app-check/cloud-functions
